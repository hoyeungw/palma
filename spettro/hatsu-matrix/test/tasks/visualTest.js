...
export class VisualTest {
  ...
  static testMatrix () {
    const { lapse, result } = Chrono.strategies({
      ...
      funcList: {
        // pointwise: (mx, hatsu-matrix) => Visual.matrix(mx, { mark: hatsu-matrix, direct: 0 }),
        // rowwise: (mx, hatsu-matrix) => Visual.matrix(mx, { mark: hatsu-matrix, direct: 0, mutate: false, retFn: true }),
