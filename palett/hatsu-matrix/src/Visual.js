...
import { vecVisual } from './vecVisual'
import { mxVisual, mxVisualCol } from './mxVisual'
...
export class Visual {
  ...
  static vector (arr, {
    mark: {
      max = Presets.fresh.max,
      min = Presets.fresh.min,
      na = Presets.fresh.na
    } = {},
    mutate = false,
    retFn = false
  ...
  static matrix (mx, {
    mark: {
      max = Presets.subtle.max,
      min = Presets.subtle.min,
      na = Presets.subtle.na
    } = {},
    direct = 1,
    mutate = false,
    retFn = false
